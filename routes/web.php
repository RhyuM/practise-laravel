...
Route::post('change-password', 'AdminController@update')->name('change.password');
...
Route::post('account-change-password', 'BidderController@update')->name('account.change.password');